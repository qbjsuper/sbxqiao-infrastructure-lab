...
Cross-site traffic from SBY must pass through `pfSense-SBY` and then across the inter-site transport path toward SBX.
...
- Inter-site connectivity to SBX must be working before domain join and promotion
